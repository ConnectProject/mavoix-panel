export default {
  ...
  addImagesModal: {
    ...
    cancel: 'Annuler',
    addToTab: 'Ajouter',
    browseTitle: 'Parcourir les pictos',
    browseSubtitle: 'Recherchez, filtrez et écoutez les pictos. Pour les ajouter à un onglet, utilisez « Ajouter des images » sur l’onglet concerné.',
    browseClose: 'Fermer',
